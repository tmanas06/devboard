#!/bin/bash
# Deployment script for Test/Staging environment
# This script sets up infrastructure and deploys time-entry backend to test environment
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            ...
            echo ""
            echo "Deploy time-entry backend to TEST environment"
            echo ""
            echo "Options:"
